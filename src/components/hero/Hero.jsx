...
const headphoneData = [
  {
    ...
    subtitle:
      'Lorem ipsusdfgsdfsdm adipisiciezrezrezrng orem ipsum dolor sit amet consectetur adipisicing elit',
    price: '$100',
    modal: 'Modal Brown',
    bgColor: '#8b5958',
  },
  {
    id: 2,
    image: Headphone2,
    title: 'Headphones Wireless green',
    subtitle:
      'Lorem ipsusdfgsdfsdm adipisiciezrezrezrng orem ipsum dolor sit amet consectetur adipisicing elit',
    price: '$100',
    modal: 'Modal Green',
  ...
  },
  {
    id: 3,
    image: Headphone3,
    title: 'Headphones Wireless blue',
    subtitle:
      'Lorem ipsusdfgsdfsdm adipisiciezrezrezrng orem ipsum dolor sit amet consectetur adipisicing elit',
    price: '$100',
    modal: 'Modal blue',
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[700px]">
          ...
          <div className="flex flex-col justify-center py-14 md:py-0 xl:max-w-[500px]">
            <div className="space-y-5 text-center md:text-left">
              ...
              <div className="flex items-center justify-center text-nowrap md:justify-start gap-4 !mt-24">
